<template>
  ...
  <section class=" area relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
    <ul class="circles">
      <li></li>
      <li></li>
      <li></li>
      ...
      <div class="-mx-4 flex flex-wrap lg:justify-between">
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            <span class="text-secondary mb-4 block text-base font-semibold">
              Contactez-nous
            </span>
            ...
            <p class="text-body-color mb-9 text-base leading-relaxed">
              Nous serions ravis de vous entendre ! Veuillez remplir le formulaire de contact ci-dessous afin que nous
              puissions répondre à vos questions et demandes dans les plus brefs délais. Votre satisfaction est notre
              priorité.
            </p>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
                class="bg-secondary text-secondary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
              ...
              <div class="w-full">
                <h4 class="text-dark mb-1 text-xl font-bold">Notre localisation</h4>
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">+33 6 12 34 56 78</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
            ...
            <form>
              <div class="mb-6">
                <input type="text" placeholder="Votre Nom"
                  class="text-body-color border-[f0f0f0] focus:border-secondary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" />
              </div>
              <div class="mb-6">
              ...
              <div class="mb-6">
                <textarea rows="6" placeholder="Votre Message"
                  class="text-body-color border-[f0f0f0] focus:border-secondary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
              </div>
              <div>
                <button type="submit"
                  class="bg-secondary border-secondary w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                  Envoyer le message
                </button>
              </div>
            </form>
