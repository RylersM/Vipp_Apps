      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="mb-10 w-full">
            <div class="my-10">
              <a href="/">
                <span class="text-3xl font-bold text-white" style="font-family: Nunito;"> Vipp Apps</span>
              </a>

            </div>
            <p class="text-body-color mb-7  text-base">
              Explorez un univers infini d'applications web et découvrez de nouvelles façons de vous connecter, créer et innover.
            </p>
            ...
            <ul>
              <li>
                <a href="javascript:void(0)"
                  class="text-body-color hover:text-yellow-500 mb-2 inline-block text-base leading-loose">
                  Développement des SaaS
                </a>
              </li>
              <li>
                <a href="javascript:void(0)"
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="mb-10 w-full">
            <h4 class="text-dark mb-9 text-lg font-semibold">Entreprise</h4>
            <ul>
              <li>
                <a href="javascript:void(0)"
                  class="text-body-color hover:text-yellow-500 mb-2 inline-block text-base leading-loose">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="text-body-color text-base">&copy; 2023 VipApps</p>
          </div>
        </div>
      </div>
    </div>
