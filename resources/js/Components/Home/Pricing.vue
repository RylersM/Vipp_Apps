...
<section
  class="relative z-20 overflow-hidden shadow-xl bg-white pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]"
>
  <div class="container mx-auto">
    ...
    <div class="-mx-4 flex flex-wrap justify-center">
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3 ">
        <div
          class="border-primary shadow-pricing bg-slate-800 relative z-10 mb-10 overflow-hidden rounded-xl border border-opacity-20 text-white py-10 px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12"
        >
          <span class="text-primary mb-4 block text-lg font-semibold">
            Business
          </span>
