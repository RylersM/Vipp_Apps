<template>
    ...
    <section class="pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap cursor-pointer">
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                        <span class="text-secondary mb-2 block text-lg font-semibold">
                            Nos Solutions Populaires
                        </span>
                        <h2 class="text-dark mb-4 text-3xl font-bold sm:text-4xl md:text-[40px]">
                            Ce que nous offrons
                        </h2>
                        <p class="text-body-color text-base">
                            Explorez un monde d'applications web, où chaque clic ouvre la porte vers de nouvelles
                            opportunités et des expériences uniques.
                        </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap cursor-pointer">
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="bg-yellow-500 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl">
                        ...
                        <p class="text-body-color">
                            Plateforme téléphonique complète pour gestion et analyse d'appels.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        ...
                        <h4 class="text-dark mb-3 text-xl font-semibold">VScript</h4>
                        <p class="text-body-color">
                            Mini CMS. Système de gestion de contenu permettant de créer, gérer et modifier
                            facilement un script.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        ...
                        <p class="text-body-color">
                            Solution d'évaluation téléphonique pour optimiser les performances opérationnelles en
                            entreprise.
                        </p>
                    </div>
                </div>
            ...
            <div>
                <a href="/catalogue"
                            class="inline-block rounded-full border  bg-yellow-500 border-white py-3 px-9 text-base font-medium  hover:bg-yellow-600 text-white">
