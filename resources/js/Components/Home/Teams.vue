      ...
      <div class="w-full px-4">
        <div class="mx-auto mb-[60px] max-w-[510px] text-center">
          ...
          <p class="text-body-color text-base">
            Notre équipe de développeurs talentueux, dotée d'une expertise avérée, a créé ces applications exceptionnelles.
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="relative overflow-hidden rounded-lg">
            ...
            <div class="absolute bottom-5 left-0 w-full text-center">
              ...
              >
                ...
                <p class="text-body-color text-sm">Developpeur Web</p>
                <div>
          ...
          <div class="relative overflow-hidden rounded-lg">
            ...
            <div class="absolute bottom-5 left-0 w-full text-center">
              ...
              >
                ...
                <p class="text-body-color text-sm">Designer UI/UX</p>
                <div>
                  <span class="absolute left-0 bottom-0">
                    <svg
                      width="61"
          ...
          <div class="relative overflow-hidden rounded-lg">
            ...
            <div class="absolute bottom-5 left-0 w-full text-center">
              ...
              >
                ...
                <p class="text-body-color text-sm">DevOps</p>
                <div>
                  <span class="absolute left-0 bottom-0">
                    <svg
                      width="61"
